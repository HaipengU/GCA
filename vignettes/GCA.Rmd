...
sigma2a <- 0.6 # variance of additive genetic effects for simulated dataset
sigma2e <- 0.4 # variance of residual for simulated dataset
CD_IdAve <- gca(Kmatrix = G, Xmatrix = X, sigma2a = sigma2a, sigma2e = sigma2e, 
...
```{r}
CDVED1 <- gca(Kmatrix = G, Xmatrix = X, sigma2a = sigma2a, sigma2e = sigma2e, 
...
CDVED2 <- gca(Kmatrix = G, Uidx = 10, Xmatrix = X2, sigma2a = sigma2a, sigma2e = sigma2e,
